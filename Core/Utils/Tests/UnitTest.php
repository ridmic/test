...
class UnitTest_Test extends Utils\UnitTest 
{
	...
	public function test_assert_doesnt_have_key_true()      { $this->assert_true( $this->test->assert_doesnt_have_key(['a' => '1'], 'b') ); }
	public function test_assert_doesnt_have_key_false()     { $this->assert_false( $this->test->assert_doesnt_have_key(['a' => '1'], 'a') ); }
